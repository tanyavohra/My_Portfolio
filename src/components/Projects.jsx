...
const projects = [
    {
        ...
        description: "Worked as a Front-end Developer and designed the UI for a web-based Learning Management System for students.",
    ...
    },
    {
        ...
        description: "Integrated Hugging Face API for AI-powered PDF interaction, built a community-driven Q&A system with tag-based organization, and developed a responsive UI using React.js, Node.js, Express and Python microservices.",
    ...
    },
    {
        ...
        description: "As a Front-end Developer, I designed a user-friendly interface for a web-based app aimed at helping farmers with weather updates and supplies.",
...
const Projects = () => {
    ...
    return (<section id="projects" className="py-24 section-accent relative">
      <div className="container mx-auto px-6" ref={ref}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (<motion.div key={project.title} initial={{ opacity: 0, y: 40 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6, delay: 0.2 + index * 0.15 }} className="group">
              <div className="glass rounded-3xl overflow-hidden h-full flex flex-col hover:border-primary/50 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10">
                ...
                <div className={`h-48 bg-gradient-to-br ${project.gradient} flex items-center justify-center relative overflow-hidden`}>
                  ...
                  <div className="absolute inset-0 bg-primary/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <a href={project.link} className="w-12 h-12 rounded-full bg-background flex items-center justify-center hover:scale-110 transition-transform">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    {project.tags.map((tag) => (<span key={tag} className="text-xs bg-coral/10 text-coral px-3 py-1 rounded-full font-medium">
                        {tag}
                      </span>))}
                  </div>
                  ...
                  <div className="flex items-center gap-4 mt-6 pt-4 border-t border-border">
                    <a href={project.link} className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors">
